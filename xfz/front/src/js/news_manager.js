...
NewsManager.prototype.ClearSearchInfo = function () {
    var self = this;
...
NewsManager.prototype.DeleteNews = function () {
    var self = this;
    var DelBtn = $('.delete-btn');
    DelBtn.click(function () {
        var currentBtn = $(this);
        var tr = currentBtn.parent().parent();
        var newsid = tr.attr('newslist-id');
        xfzalert.WarningMessage('删除新闻', '请注意，删除后将无法恢复！', function () {
            xfzajax.post({
                'url': '/cms/news_manager/',
                'data': {
                    'pk': newsid
                },
                'success': function (result) {
                    if (result['code'] === 200) {
                        xfzalert.SuccessBox('删除新闻', '新闻删除成功！', function () {
